...
using Forxap.Banco.UI.Win.Interfaz;
...
namespace Forxap.Banco.UI.Win
{
    public class MainMenuEvent
    {
            ...
            try
            {
                ...
                if (pVal.BeforeAction)
                {
                    ...
                    switch (pVal.MenuUID)
                    {
                            ...
                            #region Modulos/Bancos 

                      
                        case AddonMenuItem.Cuotas_Migracion:
                            {
                                OnShowConciliaciones();
                            }
                            break;
                        #endregion
        ...
        private void OnShowConfigForm(string tableName)
        {
            ...
            {
                Framework.UI.Sb1Messages.ShowError(ex.ToString());
            }
            finally
            {
        ...
        private void OnShowConciliaciones()
        {
            try
            {

                wzdConciliar wizard = new wzdConciliar();
                wizard.Show();
        ...
        private void OnShowMigraCuotas()
        {
            try
            {
